...
public final class themsp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_spring_input_size_path_nobody;
  ...
  public void _jspInit() {
    _jspx_tagPool_spring_input_size_path_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    _jspx_tagPool_spring_input_size_path_nobody.release();
  ...
  private boolean _jspx_meth_spring_form_0(PageContext _jspx_page_context)
    ...
    _jspx_th_spring_form_0.setAction("luu-du-lieu.html");
    _jspx_th_spring_form_0.setCommandName("sanPham");
      ...
      if (_jspx_eval_spring_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          if (_jspx_meth_spring_input_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_spring_form_0, _jspx_page_context, _jspx_push_body_count_spring_form_0))
            return true;
          out.write("<br>\n");
          out.write("     DANH MỤC <select name=\"danhmucSanPham\">\n");
          out.write("         <option value=\"1\">NOKIA</option>\n");
          out.write("         <option value=\"2\">APPLE</option>\n");
          out.write("         <option value=\"3\">SAMSUNG</option>\n");
          out.write("         <option value=\"4\">HTC</option>\n");
          out.write("               </select>\n");
          out.write("     <input type=\"submit\" class=\"btn btn-default\" value=\"Lưu\" /><br>\n");
  ...
  private boolean _jspx_meth_spring_input_0(javax.servlet.jsp.tagext.JspTag _jspx_th_spring_form_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_spring_form_0)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  spring:input
    org.springframework.web.servlet.tags.form.InputTag _jspx_th_spring_input_0 = (org.springframework.web.servlet.tags.form.InputTag) _jspx_tagPool_spring_input_size_path_nobody.get(org.springframework.web.servlet.tags.form.InputTag.class);
    ...
    _jspx_th_spring_input_0.setPath("tenSanPham");
    _jspx_th_spring_input_0.setSize("30");
    ...
    try {
      ...
      _jspx_tagPool_spring_input_size_path_nobody.reuse(_jspx_th_spring_input_0);
    }
    return false;
  }
  ...
  private boolean _jspx_meth_spring_input_1(javax.servlet.jsp.tagext.JspTag _jspx_th_spring_form_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_spring_form_0)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  spring:input
    org.springframework.web.servlet.tags.form.InputTag _jspx_th_spring_input_1 = (org.springframework.web.servlet.tags.form.InputTag) _jspx_tagPool_spring_input_size_path_nobody.get(org.springframework.web.servlet.tags.form.InputTag.class);
    ...
    _jspx_th_spring_input_1.setPath("giaSanPham");
    _jspx_th_spring_input_1.setSize("30");
    ...
    try {
      ...
      _jspx_tagPool_spring_input_size_path_nobody.reuse(_jspx_th_spring_input_1);
    }
    return false;
  }
  ...
  private boolean _jspx_meth_spring_input_2(javax.servlet.jsp.tagext.JspTag _jspx_th_spring_form_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_spring_form_0)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  spring:input
    org.springframework.web.servlet.tags.form.InputTag _jspx_th_spring_input_2 = (org.springframework.web.servlet.tags.form.InputTag) _jspx_tagPool_spring_input_size_path_nobody.get(org.springframework.web.servlet.tags.form.InputTag.class);
    ...
    _jspx_th_spring_input_2.setPath("soluongSanPham");
    _jspx_th_spring_input_2.setSize("30");
    ...
    try {
      ...
      _jspx_tagPool_spring_input_size_path_nobody.reuse(_jspx_th_spring_input_2);
    }
    return false;
  }
}
